      ...
      <div className="bg-white p-8 rounded-3xl shadow-xl w-full max-w-md border border-gray-100">
        <div className="flex flex-col items-center mb-6">
          ...
          <h1 className="text-xl font-bold text-slate-800">
            Distribuidora Aze-Sher's
          </h1>
          <p className="text-sm text-slate-500">
            Sistema de control y gestión de ventas e inventarios
          </p>
        ...
        {forgot ? (
          <form onSubmit={requestReset} className="space-y-4">
            <p className="text-sm text-slate-600">
              Ingresa tu usuario o correo. El enlace será válido durante 30
              minutos.
            </p>
            <input
              className="input"
            ...
            <button
              ...
              className="w-full text-sm font-semibold text-brand-teal"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {mensaje && (
              <p className="text-red-500 text-xs text-center">{mensaje}</p>
            )}
            ...
            <button type="button" onClick={() => { setForgot(true); setMensaje(""); }} className="w-full text-center text-sm font-semibold text-brand-teal">¿Olvidaste tu contraseña?</button>
          </form>
        )}
